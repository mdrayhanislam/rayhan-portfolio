...
import rayhanPdf from '../../../Image/rayhan.pdf'
const Banner = () => {
      ...
      <div className="hero min-h-screen flex justify-around h-2/4 bg-gradient-to-r from-cyan-500 to-blue-500">
        ...
        <div className="hero-content flex-col lg:flex-row-reverse rounded-md ">
          ...
          <div className='d1'>
            ...
            <a href={rayhanPdf} download={rayhanPdf}>
              <button className="btn bg-gradient-to-r from-indigo-500 to-red-600 ">Download Resume</button>
            </a>
